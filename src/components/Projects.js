        ...
        projects : [
            {
                ...
                link: 'https://github.com/Nishayaaaz/Shopping-Cart.git'
            },
            {
                image: websiteImg2,
    ...
    return <section id='projects' className="flex  flex-col py-20 px-5 justify-center bg-primary text-white">
        <div className="w-full">
            <div className="flex flex-col px-10 py-5">
                ...
                <p>These are some of my best projects. I have built these with React, MERN and JavaScript. Check them out.</p>
            </div>
        </div>
        <div className="w-full">
